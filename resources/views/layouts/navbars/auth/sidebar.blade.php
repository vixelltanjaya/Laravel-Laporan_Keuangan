<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      <img src="../assets/img/Maharani_r.png" class="navbar-brand-img h-100" alt="...">
      <span class="ms-3 font-weight-bold">Maharani SIA</span>
    </a>
  </div>
  ...
  <div class="" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <!-- Coa  -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('chart-of-account') ? 'active' : '') }}" href="{{ url('chart-of-account') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>Isi Apa ya</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Master Akun</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('master-journal') ? 'active' : '') }}" href="{{ url('master-journal') }}">
          ...
          <span class="nav-link-text ms-1">Master Journal</span>
        </a>
      </li>
      ...
      <!-- Buku Besar  -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('general-ledger') ? 'active' : '') }}" href="{{ url('general-ledger') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>document</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <!-- evidence Code -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('evidence-code') ? 'active' : '') }}" href="{{ url('evidence-code') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="ni ni-ruler-pencil fa-lg ps-2 pe-2 text-center text-dark {{ (Request::is('evidence-code ') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Kode Bukti</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('closed-balance') ? 'active' : '') }}" href="{{ url('closed-balance') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="ni ni-ruler-pencil fa-lg ps-2 pe-2 text-center text-dark {{ (Request::is('closed-balance') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <!-- Reporting -->
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Pelaporan</h6>
      </li>
